...
function prototypes
    void cdft(int, int, FP_TYPE *);
    void rdft(int, int, FP_TYPE *);
    void ddct(int, int, FP_TYPE *);
    void ddst(int, int, FP_TYPE *);
    void dfct(int, FP_TYPE *);
    void dfst(int, FP_TYPE *);
macro definitions
...
-------- Complex DFT (Discrete Fourier Transform) --------
    ...
    [parameters]
        2*n            :data length (int)
                        n >= 1, n = power of 2
        a[0...2*n-1]   :input/output data (FP_TYPE *)
                        input data
                            a[2*j] = Re(x[j]), 
...
-------- Real DFT / Inverse of Real DFT --------
    ...
    [parameters]
        n              :data length (int)
                        n >= 2, n = power of 2
        a[0...n-1]     :input/output data (FP_TYPE *)
                        <case1>
                            output data
                                a[2*k] = R[k], 0<=k<n/2
                                a[2*k+1] = I[k], 0<k<n/2
...
-------- Cosine Transform of RDFT (Real Symmetric DFT) --------
    ...
    [parameters]
        n              :data length - 1 (int)
                        n >= 2, n = power of 2
        a[0...n]       :input/output data (FP_TYPE *)
                        output data
                            a[k] = C[k], 0<=k<=n
    [remark]
        Inverse of 
...
{
    void cftfsub(int n, FP_TYPE *a);
    void cftbsub(int n, FP_TYPE *a);
...
void rdft(int n, int isgn, FP_TYPE *a)
{
    void cftfsub(int n, FP_TYPE *a);
    void cftbsub(int n, FP_TYPE *a);
    void rftfsub(int n, FP_TYPE *a);
    void rftbsub(int n, FP_TYPE *a);
    FP_TYPE xi;
...
void ddct(int n, int isgn, FP_TYPE *a)
{
    void cftfsub(int n, FP_TYPE *a);
    void cftbsub(int n, FP_TYPE *a);
    void rftfsub(int n, FP_TYPE *a);
    void rftbsub(int n, FP_TYPE *a);
    void dctsub(int n, FP_TYPE *a);
    void dctsub4(int n, FP_TYPE *a);
    int j;
    FP_TYPE xr;
...
void ddst(int n, int isgn, FP_TYPE *a)
{
    void cftfsub(int n, FP_TYPE *a);
    void cftbsub(int n, FP_TYPE *a);
    void rftfsub(int n, FP_TYPE *a);
    void rftbsub(int n, FP_TYPE *a);
    void dstsub(int n, FP_TYPE *a);
    void dstsub4(int n, FP_TYPE *a);
    int j;
    FP_TYPE xr;
...
void dfct(int n, FP_TYPE *a)
{
    void ddct(int n, int isgn, FP_TYPE *a);
    void bitrv1(int n, FP_TYPE *a);
    int j, k, m, mh;
    FP_TYPE xr, xi, yr, yi, an;
...
void cftfsub(int n, FP_TYPE *a)
{
    void bitrv2(int n, FP_TYPE *a);
    void bitrv216(FP_TYPE *a);
    void bitrv208(FP_TYPE *a);
    void cftmdl1(int n, FP_TYPE *a);
    void cftrec4(int n, FP_TYPE *a);
    void cftleaf(int n, int isplt, FP_TYPE *a);
    void cftfx41(int n, FP_TYPE *a);
    void cftf161(FP_TYPE *a);
    void cftf081(FP_TYPE *a);
    void cftf040(FP_TYPE *a);
    void cftx020(FP_TYPE *a);
#ifdef USE_CDFT_THREADS
    void cftrec4_th(int n, FP_TYPE *a);
...
void cftbsub(int n, FP_TYPE *a)
{
    void bitrv2conj(int n, FP_TYPE *a);
    void bitrv216neg(FP_TYPE *a);
    void bitrv208neg(FP_TYPE *a);
    void cftb1st(int n, FP_TYPE *a);
    void cftrec4(int n, FP_TYPE *a);
    void cftleaf(int n, int isplt, FP_TYPE *a);
    void cftfx41(int n, FP_TYPE *a);
    void cftf161(FP_TYPE *a);
    void cftf081(FP_TYPE *a);
    void cftb040(FP_TYPE *a);
    void cftx020(FP_TYPE *a);
#ifdef USE_CDFT_THREADS
    void cftrec4_th(int n, FP_TYPE *a);
#endif /* USE_CDFT_THREADS */
...
void bitrv216(FP_TYPE *a)
{
    FP_TYPE x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i, 
...
void bitrv208(FP_TYPE *a)
{
    FP_TYPE x1r, x1i, x3r, x3i, x4r, x4i, x6r, x6i;
...
void cftb1st(int n, FP_TYPE *a)
{
    ...
    FP_TYPE ew, w1r, w1i, wk1r, wk1i, wk3r, wk3i, 
        wd1r, wd1i, wd3r, wd3i, ss1, ss3;
    FP_TYPE x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i;
...
void *cftrec1_th(void *p)
{
    int cfttree(int n, int j, int k, FP_TYPE *a);
    void cftleaf(int n, int isplt, FP_TYPE *a);
    void cftmdl1(int n, FP_TYPE *a);
...
void cftleaf(int n, int isplt, FP_TYPE *a)
{
    ...
    void cftmdl2(int n, FP_TYPE *a);
    void cftf161(FP_TYPE *a);
    void cftf162(FP_TYPE *a);
    void cftf081(FP_TYPE *a);
    void cftf082(FP_TYPE *a);
...
{
    int i, i0, j, j0, j1, j2, j3, m, mh;
    FP_TYPE ew, w1r, w1i, wn4r, wk1r, wk1i, wk3r, wk3i, 
        wl1r, wl1i, wl3r, wl3i, wd1r, wd1i, wd3r, wd3i, 
        we1r, we1i, we3r, we3i, ss1, ss3;
    FP_TYPE x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i, y0r, y0i, y2r, y2i;
...
void cftf162(FP_TYPE *a)
{
    FP_TYPE wn4r, wk1r, wk1i, wk2r, wk2i, wk3r, wk3i, 
...
void cftf081(FP_TYPE *a)
{
    FP_TYPE wn4r, x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i, 
        y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i, 
        y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i;
...
void cftf082(FP_TYPE *a)
{
    FP_TYPE wn4r, wk1r, wk1i, x0r, x0i, x1r, x1i, 
        y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i, 
        y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i;
...
{
    int i, i0, j, k;
    FP_TYPE ec, w1r, w1i, wkr, wki, wdr, wdi, ss, xr, xi, yr, yi;
